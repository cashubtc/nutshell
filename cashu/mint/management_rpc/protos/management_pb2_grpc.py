...
class MintStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UpdateShortDescription = channel.unary_unary(
                '/mint_rpc.Mint/UpdateShortDescription',
        ...
        self.RotateNextKeyset = channel.unary_unary(
                '/mint_rpc.Mint/RotateNextKeyset',
...
def add_MintServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'mint_rpc.Mint', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('mint_rpc.Mint', rpc_method_handlers)
