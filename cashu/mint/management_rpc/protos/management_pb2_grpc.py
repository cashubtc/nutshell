...
class MintStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CommitPanicBlindedMessages = channel.unary_unary(
                ...
                _registered_method=True)
        self.ResolvePanicMintQuotes = channel.unary_unary(
                '/cashu.Mint/ResolvePanicMintQuotes',
                request_serializer=management__pb2.PanicMintQuoteIdsRequest.SerializeToString,
                response_deserializer=management__pb2.PanicBlacklistPreviewResponse.FromString,
                _registered_method=True)
        self.CommitPanicMintQuotes = channel.unary_unary(
                '/cashu.Mint/CommitPanicMintQuotes',
                request_serializer=management__pb2.PanicMintQuoteIdsRequest.SerializeToString,
                response_deserializer=management__pb2.PanicBlacklistPreviewResponse.FromString,
                _registered_method=True)
...
class MintServicer(object):
    ...
    def ResolvePanicMintQuotes(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')

    def CommitPanicMintQuotes(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_MintServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'ResolvePanicMintQuotes': grpc.unary_unary_rpc_method_handler(
                    servicer.ResolvePanicMintQuotes,
                    request_deserializer=management__pb2.PanicMintQuoteIdsRequest.FromString,
                    response_serializer=management__pb2.PanicBlacklistPreviewResponse.SerializeToString,
            ),
            'CommitPanicMintQuotes': grpc.unary_unary_rpc_method_handler(
                    servicer.CommitPanicMintQuotes,
                    request_deserializer=management__pb2.PanicMintQuoteIdsRequest.FromString,
                    response_serializer=management__pb2.PanicBlacklistPreviewResponse.SerializeToString,
            ),
    }
...
class Mint(object):
    ...
    @staticmethod
    def ResolvePanicMintQuotes(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/cashu.Mint/ResolvePanicMintQuotes',
            management__pb2.PanicMintQuoteIdsRequest.SerializeToString,
            management__pb2.PanicBlacklistPreviewResponse.FromString,
            options,
            channel_credentials,
            insecure,
    ...
    @staticmethod
    def CommitPanicMintQuotes(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
